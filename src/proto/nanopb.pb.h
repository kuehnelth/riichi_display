...
#ifndef PB_PROTO_NANOPB_PB_H_INCLUDED
#define PB_PROTO_NANOPB_PB_H_INCLUDED
#include <pb.h>
...
extern const pb_extension_type_t nanopbo; /* field type: NanoPBOptions nanopbo; */
...
#define NanoPBOptions_init_default \
	{ false,                   \
	  0,                       \
	  false,                   \
	  0,                       \
	  false,                   \
	  FieldType_FT_DEFAULT,    \
	  false,                   \
	  true,                    \
	  false,                   \
	  false,                   \
	  ...
	  false,                   \
	  false,                   \
	  TypenameMangling_M_NONE, \
	  { { NULL }, NULL },      \
	  { { NULL }, NULL },      \
	  false,                   \
	  DescriptorSize_DS_AUTO,  \
	  false,                   \
	  false,                   \
	  false,                   \
	  false,                   \
	  ...
	  false,                   \
	  false }
#define NanoPBOptions_init_zero  \
	{ false,                 \
	  0,                     \
	  false,                 \
	  0,                     \
...
#define NanoPBOptions_DEFAULT \
	(const pb_byte_t      \
		 *)"\x20\x01\x28\x00\x30\x00\x40\x00\x50\x00\x58\x00\x60\x00\x68\x00\x78\x00\x80\x01\x00\xa8\x01\x00\xb0\x01\x00\xb8\x01\x00\xe0\x01\x01\xe8\x01\x01\x80\x02\x00\x88\x02\x01\x98\x02\x00\x00"
